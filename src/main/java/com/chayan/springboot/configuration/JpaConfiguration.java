package com.chayan.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.chayan.springboot.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.chayan.springboot.model" });
